...
export default function Index() {
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
        <Head/>
        <ModuleLayout title="Sitios Web" description="Administrar los sitios web del sistema">
                                ...
                                <td className="px-4 py-3 flex items-center justify-end">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent className="w-56" align="end">
                                            ...
                                            <DropdownMenuItem asChild>
                                                <Link className="block w-full" href='#' onClick={()=>deleteSite(item.id)} as="button" prefetch>
                                                    Delete
                                                </Link>
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
