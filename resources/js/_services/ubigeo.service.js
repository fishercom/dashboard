...
function getDepartments() {
    ...
    return fetch(`${env('API_URL')}/ubigeo/departments`, requestOptions).then(handleResponse)
}
...
function getProvinces(department_id) {
    ...
    return fetch(`${env('API_URL')}/ubigeo/provinces`, requestOptions).then(handleResponse)
}
...
function getDistricts(province_id) {
    ...
    return fetch(`${env('API_URL')}/ubigeo/districts`, requestOptions).then(handleResponse)
}
